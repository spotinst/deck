...
export interface ICreateServerGroupExecutionDetailsState {
  deployResults: IDeployResult[];
}

export class CreateServerGroupExecutionDetails extends React.Component<
  IExecutionDetailsSectionProps,
  ICreateServerGroupExecutionDetailsState
> {
  public static title = 'createServerGroupConfig';
